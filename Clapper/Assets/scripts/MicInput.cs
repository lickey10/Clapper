...
public class MicInput : MonoBehaviour
{
    ...
    public void InitMic()
    {
        ...
        _clipRecord = AudioClip.Create("Microphone", 8, 1, 44100 * 2, false);
        _recordedClip = AudioClip.Create("Microphone-Recorded", 8, 1, 44100 * 2, false);
    ...
    //AudioClip _clipRecord = new AudioClip(null);
    ...
    void Update()
    {
        ...
        if (MicLoudness > maxMicLoudness)
            maxMicLoudness = MicLoudness;
    }
    ...
    void OnGUI()
    {
        ...
        GUI.Label(new Rect(175, 0, 600, 400), "soundLevel:" + MicLoudnessinDecibels.ToString(), style);
        GUI.Label(new Rect(175, 400, 600, 400), "maxMicLoudness:" + maxMicLoudness, style);
    }
